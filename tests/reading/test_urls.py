...
class ReadingUrlsTestCase(TestCase):
    ...
    def test_reading_home_url(self):
        self.assertEqual(reverse('spectator_reading:home'), '/reading/')
    ...
    def test_publicationseries_list_home_url(self):
        self.assertEqual(reverse('spectator_reading:publicationseries_list'),
                         '/reading/series/')
    ...
    def test_publicationseries_detail_url(self):
        ...
        self.assertEqual(
            reverse('spectator_reading:publicationseries_detail', kwargs={'pk': 3}),
                        '/reading/series/3/')
    ...
    def test_publication_list_url(self):
        self.assertEqual(reverse('spectator_reading:publication_list'),
    ...
    def test_publication_list_periodical_url(self):
        self.assertEqual(reverse('spectator_reading:publication_list_periodical'),
    ...
    def test_publication_detail_url(self):
        ...
        self.assertEqual(
            reverse('spectator_reading:publication_detail', kwargs={'pk': 3}),
    ...
    def test_reading_year_archive_url(self):
        ...
        self.assertEqual(
            reverse('spectator_reading:reading_year_archive', kwargs={'year': 2017}),
                    '/reading/2017/')
