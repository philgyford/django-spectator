...
class AnnualReadingCountsTestCase(TestCase):
    ...
    def test_default(self):
        ...
        self.assertEqual(
            result[1],
            {"year": make_date("2017-01-01"), "book": 3, "periodical": 2, "total": 5},
        )
        self.assertEqual(
            result[2],
            {"year": make_date("2018-01-01"), "book": 0, "periodical": 2, "total": 2},
        )
    ...
    def test_book(self):
        ...
        self.assertEqual(result[0], {"year": make_date("2015-01-01"), "book": 2})
        self.assertEqual(result[1], {"year": make_date("2017-01-01"), "book": 3})
