...
class EventListViewTestCase(ViewTestCase):
    def test_ancestor(self):
        self.assertTrue(issubclass(views.EventListView, views.PaginatedListView))
    ...
    def test_response_404(self):
        ...
        with self.assertRaises(Http404):
            views.EventListView.as_view()(self.request, kind_slug="nope")

    def test_templates(self):
        response = views.EventListView.as_view()(self.request)
        self.assertEqual(response.template_name[0], "spectator_events/event_list.html")
...
class EventDetailViewTestCase(ViewTestCase):
    ...
    def test_response_200(self):
        "It should respond with 200."
        response = views.EventDetailView.as_view()(self.request, slug="9g5o8")
        self.assertEqual(response.status_code, 200)

    def test_response_404_pk(self):
        "It should raise 404 if there's no Event with that slug."
        with self.assertRaises(Http404):
            views.EventDetailView.as_view()(self.request, slug="nope")

    def test_templates(self):
        response = views.EventDetailView.as_view()(self.request, slug="9g5o8")
        self.assertEqual(
            response.template_name[0], "spectator_events/event_detail.html"
        )
...
class EventYearArchiveViewTestCase(ViewTestCase):
    ...
    def test_response_200(self):
        ...
        response = views.EventYearArchiveView.as_view()(self.request, year="2017")
        self.assertEqual(response.status_code, 200)

    def test_response_404(self):
        "It should raise 404 if it's a date before our first year."
        with self.assertRaises(Http404):
            views.EventYearArchiveView.as_view()(self.request, year="2016")

    def test_templates(self):
        response = views.EventYearArchiveView.as_view()(self.request, year="2017")
        self.assertEqual(
            response.template_name[0], "spectator_events/event_archive_year.html"
        )
...
class WorkListViewTestCase(ViewTestCase):
    ...
    def test_templates(self):
        response = views.WorkListView.as_view()(self.request, kind_slug="movies")
        self.assertEqual(response.template_name[0], "spectator_events/work_list.html")
...
class WorkDetailViewTestCase(ViewTestCase):
    ...
    def test_response_200(self):
        "It should respond with 200."
        response = views.WorkDetailView.as_view()(
    ...
    def test_response_404_invalid_kind_slug(self):
        "It should respond with 404."
        with self.assertRaises(Http404):
            views.WorkDetailView.as_view()(self.request, kind_slug="nope", slug="9g5o8")

    def test_templates(self):
        response = views.WorkDetailView.as_view()(
            self.request, kind_slug="movies", slug="9g5o8"
        )
        self.assertEqual(response.template_name[0], "spectator_events/work_detail.html")
    ...
    def test_context(self):
        ...
        self.assertEqual(response.context_data["breadcrumb_list_title"], "Movies")
        self.assertIn("breadcrumb_list_url", response.context_data)
        self.assertEqual(
            response.context_data["breadcrumb_list_url"], "/events/movies/"
        )
...
class VenueListViewTestCase(ViewTestCase):
    ...
    def test_templates(self):
        response = views.VenueListView.as_view()(self.request)
        self.assertEqual(response.template_name[0], "spectator_events/venue_list.html")
    ...
    def test_context_country_list(self):
        ...
        self.assertEqual(
            context["country_list"][0], {"code": "CH", "name": "Switzerland"}
        )
        self.assertEqual(context["country_list"][1], {"code": "GB", "name": "UK"})
        self.assertEqual(context["country_list"][2], {"code": "UY", "name": "Uruguay"})
...
class VenueDetailViewTestCase(ViewTestCase):
    ...
    def test_ancestor(self):
        self.assertTrue(issubclass(views.VenueListView, views.PaginatedListView))
    ...
    def test_response_404(self):
        ...
        with self.assertRaises(Http404):
            views.VenueDetailView.as_view()(self.request, slug="nope")

    def test_templates(self):
        response = views.VenueDetailView.as_view()(self.request, slug="9g5o8")
        self.assertEqual(
            response.template_name[0], "spectator_events/venue_detail.html"
        )
