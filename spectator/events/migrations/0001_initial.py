# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-10 12:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('gig', 'Gig'), ('misc', 'Misc'), ('movie', 'Movie'), ('play', 'Play')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_roles', to='core.Creator')),
        ...
        migrations.AddField(
            model_name='event',
            name='creators',
            field=models.ManyToManyField(related_name='events', through='events.EventRole', to='core.Creator'),
        ),
        migrations.AddField(
            model_name='event',
            name='movie',
            field=models.ForeignKey(blank=True, help_text="Only used if event is of 'movie' kind.", on_delete=django.db.models.deletion.CASCADE, to='events.Movie'),
        ),
        migrations.AddField(
            model_name='event',
            name='play',
            field=models.ForeignKey(blank=True, help_text="Only used if event is of 'play' kind.", on_delete=django.db.models.deletion.CASCADE, to='events.Play'),
        ),
        migrations.AddField(
            model_name='event',
            name='venue',
