    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='publication_roles', to='core.Creator')),
                ('publication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='reading.Publication')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reading.Publication')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='creators',
            field=models.ManyToManyField(related_name='publications', through='reading.PublicationRole', to='core.Creator'),
        ),
        migrations.AddField(
            model_name='publication',
            name='series',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='reading.PublicationSeries'),
        ),
    ]
